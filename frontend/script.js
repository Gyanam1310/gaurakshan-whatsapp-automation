...
async function loadFamilies() {
  ...
  try {
    console.log("[folders] Fetching families from:", FOLDERS_API_URL);
    ...
    const foldersPayload = Array.isArray(data)
      ? data
...
messageForm.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    console.log("save-donation response status:", response.status);
