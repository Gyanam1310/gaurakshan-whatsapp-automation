...
const importantRoutes = Object.freeze([
  ...
  { method: "GET", path: "/api/get-folders", description: "List image folders (API prefix)" },
  { method: "GET", path: "/images", description: "List images" },
  { method: "GET", path: "/api/images", description: "List images (API prefix)" },
  { method: "POST", path: "/save-donation", description: "Save donation record" },
  { method: "POST", path: "/api/save-donation", description: "Save donation record (API prefix)" },
  { method: "POST", path: "/submit", description: "Alias of save donation" },
  { method: "POST", path: "/api/submit", description: "Alias of save donation (API prefix)" },
  { method: "POST", path: "/send-message", description: "Send WhatsApp message" },
  { method: "POST", path: "/api/send-message", description: "Send WhatsApp message (API prefix)" },
  { method: "POST", path: "/test-whatsapp", description: "Test WhatsApp connectivity" },
  { method: "POST", path: "/api/test-whatsapp", description: "Test WhatsApp connectivity (API prefix)" },
]);
