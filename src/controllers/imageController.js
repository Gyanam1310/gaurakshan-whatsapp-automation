...
async function getFolders(req, res) {
  console.log("Families API hit");
  console.log("[GET /get-folders] Request started");
  console.log("[GET /get-folders] Request URL:", req.originalUrl);
  ...
  console.log("[GET /get-folders] GOOGLE_SERVICE_ACCOUNT_KEY:", keyFileFromEnv);
  console.log("[GET /get-folders] Resolved key file path:", keyFilePath);
  console.log("[GET /get-folders] Key file exists:", fs.existsSync(keyFilePath));
  ...
  try {
    ...
    console.log("[GET /get-folders] Drive list query:", parentQuery);
    ...
    async function listAllFolders(query) {
      ...
      do {
        console.log("[GET /get-folders] Drive API call", {
          query,
    ...
    console.error("[GET /get-folders] Error code:", error.code || "<none>");
    console.error("[GET /get-folders] Error name:", error.name || "<none>");
    console.error("[GET /get-folders] Error status:", error.response?.status || "<none>");
    console.error("[GET /get-folders] Error response headers:", error.response?.headers || "<none>");
    console.error("[GET /get-folders] Error response body:", error.response?.data || "<none>");
